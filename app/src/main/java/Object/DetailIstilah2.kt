...
fun DetailIstilahBagian2(
    ...
    val istilah = DetailIstilah2Data(
...
@Composable
fun DetailContent2(istilah: DetailIstilah2Data) {
    Column(
        modifier = Modifier
            .fillMaxWidth(),
...
@Composable
fun ActionButtonsBagian2(istilah: DetailIstilah2Data) {
